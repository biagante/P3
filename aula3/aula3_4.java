...
public class aula3_4{
	...
	static void addUser() {
		...
		if(type == 1) {
			...
			User s = new Student(new Data(d,m,a),nome,cc,new Data(dia,mes,ano),nmec,curso);
			spot.addUser(s);
		} 
		else if(type == 2) {
			...
			User e = new Employee(new Data(d,m,a),nome,cc,new Data(dia,mes,ano),numEmp,numFisc);
			spot.addUser(e);
		}
